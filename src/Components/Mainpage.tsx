...
export default function Mainpage() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center"
      ...
      {/* Ajustado: Se quitó el translateX(-50%) y se adaptó el 'left' para no interferir con el keyframe */}
      ...
      <div className="relative z-10 flex flex-col gap-4 w-64">
        <button
          ...
          className="w-full py-4 rounded-full text-white text-xl font-semibold transition transition-transform duration-200 hover:opacity-80 hover:scale-105 hover:shadow-lg"
